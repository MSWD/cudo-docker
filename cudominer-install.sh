...
if [ "$UPDATE_CHANNEL" == "1" ]; then
  ...
  if [ "$INSTALL_TYPE" == "1" ]; then
    ...
    wget -O ${DESKTOP_TEMP} https://download.cudo.org/tenants/135790374f46b0107c516a5f5e13069b/5e5f800fdf87209fdf8f9b61441e53a1/linux/x64/release/v1.7.7/cudo-miner-desktop.deb
    wget -O ${CORE_TEMP} https://download.cudo.org/tenants/135790374f46b0107c516a5f5e13069b/5e5f800fdf87209fdf8f9b61441e53a1/linux/x64/release/v1.7.7/cudo-miner-core.deb
    wget -O ${SERVICE_TEMP} https://download.cudo.org/tenants/135790374f46b0107c516a5f5e13069b/5e5f800fdf87209fdf8f9b61441e53a1/linux/x64/release/v1.7.7/cudo-miner-service.deb
    ...
    if [ "$CMD_TOOLS" == "y" ]; then
      ...
      wget -O ${HEADLESS_TEMP} https://download.cudo.org/tenants/135790374f46b0107c516a5f5e13069b/5e5f800fdf87209fdf8f9b61441e53a1/linux/x64/release/v1.7.7/cudo-miner-headless.deb
      wget -O ${CORE_TEMP} https://download.cudo.org/tenants/135790374f46b0107c516a5f5e13069b/5e5f800fdf87209fdf8f9b61441e53a1/linux/x64/release/v1.7.7/cudo-miner-core.deb
      wget -O ${CLI_TEMP} https://download.cudo.org/tenants/135790374f46b0107c516a5f5e13069b/5e5f800fdf87209fdf8f9b61441e53a1/linux/x64/release/v1.7.7/cudo-miner-cli.deb
      wget -O ${SERVICE_TEMP} https://download.cudo.org/tenants/135790374f46b0107c516a5f5e13069b/5e5f800fdf87209fdf8f9b61441e53a1/linux/x64/release/v1.7.7/cudo-miner-service.deb
...
if [ "$UPDATE_CHANNEL" == "1" ] || [ "$UPDATE_CHANNEL" == "2" ]; then
  ...
  if [ "$INSTALL_TYPE" == "1" ]; then
    echo "Installing the desktop packages..."
    apt-get ${APT_ARGS} install cudo-miner-desktop
  elif [ "$INSTALL_TYPE" == "2" ]; then
    if [ "$CMD_TOOLS" == "y" ]; then
      echo "Installing the headless packages..."
      apt-get ${APT_ARGS} install cudo-miner-headless
    elif [ "$CMD_TOOLS" == "n" ]; then
      echo "Installing the headless packages without command line tools..."
      apt-get ${APT_ARGS} install cudo-miner-core cudo-miner-service
    fi
  fi
fi
